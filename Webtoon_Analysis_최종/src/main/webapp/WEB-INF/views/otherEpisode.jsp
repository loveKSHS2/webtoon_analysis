      ...
      <div id="content">
       ...
       <div class="container-fluid">
         ...
         <div class="row">
               ...
               <div class="card-body">
                 <div class="row no-gutters align-items-center">
                   <div class="col mr-2">
                     ...
                     <c:forEach items="${memberList}" var="info">
                     <c:if test="${info.episode == episode && info.title == selectedToon}">
           ...
           <div class="col-xl-10 col-md-7 mb-4">
               <div class="card border-left-primary shadow h-100 py-2">
                 <div class="card-body">
                   <div class="row no-gutters align-items-center">
                     <div class="col mr-2">
                       <div class="nanum text-l font-weight-bold text-primary text-uppercase mb-1">댓글 요약 결과<br></div>
                       <div class="nanum text-m font-weight-bold mb-1">3줄 요약</div>
                       <c:forEach items="${summaryList}" var="summary">
                       <c:if test="${summary.episode == episode && summary.title == selectedToon}">
                       ...
                       <c:if test="${summarykeyword.episode == episode && summarykeyword.title == selectedToon}">
                       <div class="jeju mb-0 mr-3 text-gray-800">
  ...
  var writerbarchart = new Chart(contents, {
    ...
    data: {
      ...
      labels: [
    	 ...
    	 <c:if test="${keyword.episode == episode && keyword.sep == '작가' }"> 
    	  "${keyword.word}",
    	 </c:if>
    	 </c:forEach> 
...
var myPieChart = new Chart(ctx, {
 ...
 data: {
   ...
   datasets: [{ 
     data: [
     <c:forEach items="${sentimentList}" var="sentiment">
     <c:if test="${sentiment.title == selectedToon && sentiment.episode == episode}">	 
...
var myLineChart = new Chart(ctx, {
  ...
  data: {
    ...
    <c:if test="${twitter.title == selectedToon && twitter.episode >= episode && twitter.episode <= episode+4}">
    	"${twitter.episode}화",
    ...
    datasets: [{
      ...
      data: [
      <c:forEach items="${memberList}" var="info" >
      <c:if test="${info.title == selectedToon && info.episode >= episode && info.episode <= episode+4}">
...
var piecebarchart = new Chart(contents, {
  ...
  data: {
    ...
    labels: [
    <c:forEach items="${keywordList}" var="keyword">
    <c:if test="${keyword.title == '8월의 눈보라' && keyword.episode == episode && keyword.sep == '작품'}">
    "${keyword.word}",
	</c:if>
    </c:forEach>
    ],
